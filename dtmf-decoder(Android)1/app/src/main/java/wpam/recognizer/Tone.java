...
public class Tone {
	...
	public boolean isDistinct(boolean[] distinct) {
		if(match(lowFrequency, distinct) && match(highFrequency,distinct))
			return true;
		return false;
	}

	
	private boolean match(int frequency, boolean[] distinct) {
